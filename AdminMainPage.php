...
<div class="container-fluid">
	...
	<div class="card shadow donation text-center donation">
        ...
        <?php
            ...
            $queryDonation = "SELECT AmountDonated from user WHERE NOT UserID='1'";
            ...
            echo "<form action='admin-manager' method='post'><input class='btn btn-outline-secondary btn-lg' type='submit' name='action' value='Place Order'></form>";
        ?>
...
<div class="container-fluid padding">
    ...
    <?php
        $queryClientList = "SELECT * from user WHERE UserType='Customer'";
        ...
        if($resultCheck > 0){
            while($client = mysqli_fetch_assoc($clientList)){
                ...
                echo "<h3 class='OrderHeader'>User #".$client['UserID']."</h3>";
                ...
                echo "<form action='admin-manager.php' method='post'><input type='hidden' name='UsrID' value='". $client['UserID'] ."'>";
    ...
    <?php
        $queryClientList = "SELECT * from user WHERE UserType='Owner'";
        $clientList = mysqli_query($conn, $queryClientList);
        $resultCheck = mysqli_num_rows($clientList);
        ...
        if($resultCheck > 0){
            while($client = mysqli_fetch_assoc($clientList)){
                ...
                $queryResInfo = "SELECT * from restaurant WHERE UserID='".$client['UserID']."'";
                ...
                echo "<div class='col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-2 text-center'>";
                echo "<form action='admin-manager.php' method='post'><input type='hidden' name='UsrID' value='". $client['UserID'] ."'><input type='hidden' name='ResID' value='". $resInfo['RestaurantID'] ."'>";
    ...
    <?php
        $queryClientList = "SELECT * from user WHERE UserType='Rider'";
        $clientList = mysqli_query($conn, $queryClientList);
        $resultCheck = mysqli_num_rows($clientList);
